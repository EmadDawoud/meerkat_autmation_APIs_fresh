...
class ApiClient {
    constructor() {
         ...
         * @type {String}
         * @default https://virtserver.swaggerhub.com/EMADSAMU/MeerkatAuoAPIs/1.1.0
         */
       // this.basePath = 'https://virtserver.swaggerhub.com/EMADSAMU/MeerkatAuoAPIs/1.1.0'.replace(/\/+$/, '');
       this.basePath = 'http://meerkat-api-host:8080/EMADSAMU/MeerkatAuoAPIs/1.1.0'.replace(/\/+$/, '');
        /**
 ...
 * @version 1.1.0
 */
class AllOfCollectorVMProvince {
  /**
 ...
 * @module model/AllOfDeviceVendor
 * @version 1.1.0
 */
class AllOfDeviceVendor {
  /**
   * Constructs a new <code>AllOfDeviceVendor</code>.
   * @alias module:model/AllOfDeviceVendor
   * @class
   */
  constructor() {
  }
  ...
  /**
   * Constructs a <code>AllOfDeviceVendor</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AllOfDeviceVendor} obj Optional instance to populate.
   * @return {module:model/AllOfDeviceVendor} The populated <code>AllOfDeviceVendor</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new AllOfDeviceVendor();
      if (data.hasOwnProperty('id'))
        obj.id = ApiClient.convertToType(data['id'], 'Number');
      if (data.hasOwnProperty('name'))
        obj.name = ApiClient.convertToType(data['name'], 'String');
 ...
 * @member {Number} id
 */
AllOfDeviceVendor.prototype.id = undefined;

/**
 * missing description
 * @member {String} name
 */
AllOfDeviceVendor.prototype.name = undefined;
 ...
 * @version 1.1.0
 */
class AllOfSNMPCollectorCommunityStr {
  /**
 ...
 * @version 1.1.0
 */
class AllOfSNMPCollectorKPIStats {
  /**
...
exports.AllOfCollectorVMProvince = AllOfCollectorVMProvince;
exports.AllOfDeviceCommunityStr = AllOfDeviceCommunityStr;
exports.AllOfDeviceDeviceType = AllOfDeviceDeviceType;
exports.AllOfDeviceKPIStats = AllOfDeviceKPIStats;
exports.AllOfDeviceProvince = AllOfDeviceProvince;
exports.AllOfDeviceSNMPCollector = AllOfDeviceSNMPCollector;
exports.AllOfDeviceVendor = AllOfDeviceVendor;
...
exports.AllOfSNMPCollectorCommunityStr = AllOfSNMPCollectorCommunityStr;
exports.AllOfSNMPCollectorKPIStats = AllOfSNMPCollectorKPIStats;
...
exports.KPIStats = KPIStats;
exports.KPIStatsApi = KPIStatsApi;
