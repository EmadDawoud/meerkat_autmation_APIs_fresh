...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AllOfMetricSNMPMIB', function() {
      beforeEach(function() {
        instance = new MeerkatAutomationApis.AllOfMetricSNMPMIB();
      });

      it('should create an instance of AllOfMetricSNMPMIB', function() {
        // TODO: update the code to test AllOfMetricSNMPMIB
        expect(instance).to.be.a(MeerkatAutomationApis.AllOfMetricSNMPMIB);
      });
