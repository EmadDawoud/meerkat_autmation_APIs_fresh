...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SNMPMIB', function() {
      beforeEach(function() {
        instance = new MeerkatAutomationApis.SNMPMIB();
      });

      it('should create an instance of SNMPMIB', function() {
        // TODO: update the code to test SNMPMIB
        expect(instance).to.be.a(MeerkatAutomationApis.SNMPMIB);
      });
