...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AllOfSNMPCollectorCollectorVM', function() {
      beforeEach(function() {
        instance = new MeerkatAutomationApis.AllOfSNMPCollectorCollectorVM();
      });

      it('should create an instance of AllOfSNMPCollectorCollectorVM', function() {
        // TODO: update the code to test AllOfSNMPCollectorCollectorVM
        expect(instance).to.be.a(MeerkatAutomationApis.AllOfSNMPCollectorCollectorVM);
      });
