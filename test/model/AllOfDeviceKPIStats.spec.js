...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AllOfDeviceKPIStats', function() {
      beforeEach(function() {
        instance = new MeerkatAutomationApis.AllOfDeviceKPIStats();
      });

      it('should create an instance of AllOfDeviceKPIStats', function() {
        // TODO: update the code to test AllOfDeviceKPIStats
        expect(instance).to.be.a(MeerkatAutomationApis.AllOfDeviceKPIStats);
      });
