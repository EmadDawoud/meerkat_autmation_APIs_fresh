...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AllOfMonObjSNMPMIB', function() {
      beforeEach(function() {
        instance = new MeerkatAutomationApis.AllOfMonObjSNMPMIB();
      });

      it('should create an instance of AllOfMonObjSNMPMIB', function() {
        // TODO: update the code to test AllOfMonObjSNMPMIB
        expect(instance).to.be.a(MeerkatAutomationApis.AllOfMonObjSNMPMIB);
      });
