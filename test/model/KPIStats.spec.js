...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('KPIStats', function() {
      beforeEach(function() {
        instance = new MeerkatAutomationApis.KPIStats();
      });

      it('should create an instance of KPIStats', function() {
        // TODO: update the code to test KPIStats
        expect(instance).to.be.a(MeerkatAutomationApis.KPIStats);
      });
